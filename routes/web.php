...
Route::get('wishlist/session/get','SessionController@accessSessionData');
Route::get('wishlist/session/set','SessionController@storeSessionData');
Route::get('wishlist/session/remove','SessionController@deleteSessionData');
