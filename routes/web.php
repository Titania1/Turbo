...
Route::post('/whishlist/add/{part}', 'whishlistController@add')->name('whishlistFacade.add');
Route::post('/whishlist/remove/{part}', 'whishlistController@remove')->name('whishlistFacade.remove');
