		...
		<div class="about__indicators">
			<div class="about__indicators-body">
				<div class="about__indicators-item">
					...
					<div class="about__indicators-item-title">@lang('Stores around the world')</div>
				</div>
				<div class="about__indicators-item">
					<div class="about__indicators-item-value">80 000</div>
					<div class="about__indicators-item-title">@lang('Original auto parts')</div>
				</div>
				<div class="about__indicators-item">
					<div class="about__indicators-item-value">5 000</div>
					<div class="about__indicators-item-title">@lang('Satisfied customers')</div>
				</div>
			</div>
		</div>
	</div>
