			...
			<table class="wishlist__table">
				...
				<tbody class="wishlist__body">
					<tr class="wishlist__row wishlist__row--body">
						<td class="wishlist__column wishlist__column--body wishlist__column--image"><a href="#"><img src="/images/products/product-1-160x160.jpg" alt="@lang('Photo')"></a></td>
					...
					<tr class="wishlist__row wishlist__row--body">
						<td class="wishlist__column wishlist__column--body wishlist__column--image"><a href="#"><img src="/images/products/product-2-160x160.jpg" alt="@lang('Photo')"></a></td>
						<td class="wishlist__column wishlist__column--body wishlist__column--product">
					...
					<tr class="wishlist__row wishlist__row--body">
						<td class="wishlist__column wishlist__column--body wishlist__column--image"><a href="#"><img src="/images/products/product-3-160x160.jpg" alt="@lang('Photo')"></a></td>
						<td class="wishlist__column wishlist__column--body wishlist__column--product">
